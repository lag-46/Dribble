            ...
            <div class="row text-center">
                <div class="col-md-4">
                    <div class="card border-0">
                        <img src="img1.png" class="card-img-top" alt="Latest News">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card border-0">
                        <img src="img2.png" class="card-img-top" alt="Top Reviews">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card border-0">
                        <img src="img3.png" class="card-img-top" alt="Community">
                        <div class="card-body">
    ...
    <section id="games" class="bg-light py-5">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        <img src="img4.png" class="card-img-top" alt="Game 1">
                        <div class="card-body">
